...
namespace Ogx.Shared.Hosting.Microservices.Filters;
...
public sealed class RequestResponseActionFilterAttribute : Attribute, IActionFilter
{
        ...
        IStringLocalizerFactory factory)
    {
        ...
        _serializerSettings = new JsonSerializerSettings
        {
            ...
            NullValueHandling =_settings.IgnoreNullValueForJsonResponse ? NullValueHandling.Ignore : NullValueHandling.Include,
            ...
            string newContent = context.Result switch
            {
                ObjectResult or => JsonConvert.SerializeObject(
                    new BaseResponse<object>
                    {
                        ...
                        StatusMessages = [_handler.GetStatusCodeDescription((int)HttpStatusCode.OK)],
                        Payload = or.Value
                    }
                    , _serializerSettings),
